        ...
        <div className="hero-content flex-col-reverse lg:flex-row items-center justify-between gap-10 max-w-6xl mx-auto px-6">
          ...
          <div className="text-center lg:text-left max-w-xl">
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-4 justify-center lg:justify-start">
              {user ? (
                <>
                  <Link to="/dashboard" className="btn btn-outline btn-primary hover:bg-[#8b5e3c] transition duration-300">
                    Lihat Daftar Hewan
                  </Link>
                  <Link to="/myadoptions" className="btn btn-outline btn-secondary hover:bg-pink-400  transition duration-300">
                    Status Adopsi Saya
                  </Link>
                </>
              ) : (
                <>
                  <Link to="/login" className="btn btn-outline btn-primary hover:bg-[#8b5e3c] transition duration-300">
                    Masuk
                  </Link>
                  <Link to="/register" className="btn btn-outline btn-secondary hover:bg-pink-400 transition duration-300">
                    Daftar Sekarang
                  </Link>
                </>
              )}
